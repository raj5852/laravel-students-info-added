...
class UserForm extends Model
{
    ...
    protected $hidden = ['division', 'district', 'upazila', 'batch', 'designation'];
    ...
    static  function scopeSearch()
    {
        ...
        return self::where('status', 'active')
            ...
            ->with(['divisiondata:id,name', 'districtdata:id,name', 'upaziladata:id,name', 'batchdata:id,name', 'designationdata:id,name'])
            ->get();
    }
}
